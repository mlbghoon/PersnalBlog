...
class BasicButton extends React.Component{
	...
	render () {
		...
		btnClass =  (this.props.value) ? 'scrm-btn ' + this.props.size + ' ' + this.props.color + fiiled  + (this.props.onlyDisplay? ' display-only' : ''): btnClass = 'scrm-btn ' + this.props.size + ' ' + this.props.color + fiiled + innerImage +  (this.props.onlyDisplay? ' display-only' : '');
